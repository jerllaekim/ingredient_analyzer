        ...
        payload = {
            "contents": [{
                "parts": [{
                    ...
                    2. 식품유형과 비고에 따른 실험 규격을 설명해주세요, pdf파일의 79~309페이지를 참고해야 합니다. (표 형식으로 간단하게)
                    3. 미생물에 해당하는 규격만 알려주면 됩니다. 다만 이거는 틀리면 안되기에 샅샅이 뒤져서 식품유형과 비고에 해당하는 모든 미생물 규격을 알려주세요
                    4. 식품유형에 따른 것도 다 알려주어야 합니다. 비고만 검색하면 안됩니다. 표의 행마다 출처 다세요, 추정하지말고 제대로쓰세요 시발아
                    5. 답변하고 마지막에 출처를 표시하세요. 거짓말은 허용하지 않습니다. 모르면 차라리 모른다고 하세요 [출처: 공전, Page X] 
                    """
                }]
            }]
        }
